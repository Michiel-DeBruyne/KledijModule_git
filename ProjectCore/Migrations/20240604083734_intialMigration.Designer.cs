...
namespace ProjectCore.Migrations
{
    ...
    [Migration("20240604083734_intialMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProjectCore.Domain.Entities.Gebruiker.ApplicationUser", b =>
                {
                    ...
                    b.Property<string>("tel_privé_gsm")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("tel_werk_gsm")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("tel_werk_vast")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("tel_werk_verkort")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ProjectCore.Domain.Entities.Gebruiker.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProjectCore.Domain.Entities.Bestellingen.Order", b =>
                {
                    b.HasOne("ProjectCore.Domain.Entities.Gebruiker.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
