    ...
    public class AddBestelPeriode
    {
        ...
        public class CommandHandler : IRequestHandler<Command, Result>
        {
            ...
            public async Task<Result> Handle(Command request, CancellationToken cancellationToken)
            {
                try
                {
                    var bestelperiode = request.Adapt<WebShopConfiguration>();
                    await _context.WebShopConfigurations.AddAsync(bestelperiode);
                ...
                catch (DbUpdateException ex)
                {
                    ...
                    return new ErrorResult("Er is een databasefout opgetreden bij het toevoegen van de bestelperiode");
                }
                catch (Exception ex)
                {
                    // Log de uitzondering
